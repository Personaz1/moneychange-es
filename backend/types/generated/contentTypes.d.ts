...
export interface ApiRateRate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::rate.rate'> &
      Schema.Attribute.Private;
    manual_override: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    quote_currency: Schema.Attribute.String & Schema.Attribute.Required;
    rate_value: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configure global site settings like exchange margin.';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    margin_percentage: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        ...
        number
      > &
      Schema.Attribute.DefaultTo<2.6>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
